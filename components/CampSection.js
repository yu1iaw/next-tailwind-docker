            ...
            <div className="h-full flex flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
                ...
                <div className="flexCenter gap-6">
                    <span className="flex -space-x-4 overflow-hidden">
                        {PEOPLE_URL.map(url => (
                            <Image src={url} alt="person" key={url} width={52} height={52} className="inline-block w-10 h-10 rounded-full" />
                        ))}
                    </span>
...
const CampSection = () => {
    return (
        <section className="relative 2xl:max-container flex flex-col py-10 lg:mb-10 lg:py-14 xl:mb-20">
            <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
                ...
                <CampSite 
                    ...
                    subtitle="Lembah Kidang"
                    peopleJoined="40+ Joined"
                />
            </div>
            <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
                <div className="bg-green-50/95 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
